      ...
      <div className="flex gap-4 overflow-x-auto pb-4 custom-scrollbar">
        {columnsList.map((colKey) => {
          ...
          return (
            <div
              key={colKey}
              className="min-w-[280px] max-w-[280px] bg-slate-900/80 border border-slate-800/80 rounded-2xl flex flex-col max-h-[calc(100vh-180px)] shadow-lg"
            >
              {/* Column Header */}
                ...
                {cards.map((card) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-1 text-xs">
                      <a
                        href={`/api/v1/shipments/${card.shipmentId}/ebol`}
                        target="_blank"
                      ...
                      {colKey !== 'SETTLED' && (
                        <button
                          ...
                          className="px-2 py-1 bg-indigo-600/20 hover:bg-indigo-600 text-indigo-300 hover:text-white border border-indigo-500/30 rounded text-[11px] font-bold transition flex items-center gap-1"
                        >
